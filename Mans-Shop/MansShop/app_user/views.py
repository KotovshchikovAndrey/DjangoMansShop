...
from .forms import *
from .services import registration, get_form_errors, send_mail_for_reset_password, change_user_password
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            if user:
                ...
                if mail:
                    return HttpResponse('Письмо Успешно Оправленно, проверьте свою почту')

                return HttpResponse('Ошибка отправки письма, посвторите поппытку позже,возможно такого Email не существует, проверьте правильно ли вы написали адресс почты')
